...
//     useEffect(() => {
//         const ordersRef = query(collection(database, 'orders'), orderBy('timestamp', 'desc')); 
...
//                     .filter((order) => order.timestamp) // Ensure timestamp exists
...
//         if (!validTransitions[order.orderStatus.toLowerCase()]?.includes(status)) {
...
//             if (order) {
//                 updateOrderStatus(order.id, multiplestatus);
//             }
//         });
