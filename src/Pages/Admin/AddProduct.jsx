        ...
        <div>
            ...
            <div className='flex flex-col p-10 gap-5'>
                ...
                <input type="text"
                    ...
                    required
                    className='md:w-2/4 rounded-lg p-3' />
                <input type="number"
                    placeholder="Price"
                    value={productPrice}
                ...
                <textarea
                    ...
                    className='md:w-2/4 h-44 rounded-lg p-3'
                    required />
                ...
                <button
                    onClick={addProduct}
                    className={`px-4 py-2 md:w-2/4 bg-yellow-600 text-white rounded-lg ${uploading && 'opacity-50'}`}
                    disabled={uploading}
                >
